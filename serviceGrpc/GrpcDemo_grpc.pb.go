...
func (c *demoServiceClient) UnaryCall(ctx context.Context, in *DemoRequest, opts ...grpc.CallOption) (*DemoReply, error) {
	out := new(DemoReply)
	err := c.cc.Invoke(ctx, "/demo.DemoService/UnaryCall", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDemoServiceServer) UnaryCall(context.Context, *DemoRequest) (*DemoReply, error) {
...
func _DemoService_UnaryCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/demo.DemoService/UnaryCall",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServiceServer).UnaryCall(ctx, req.(*DemoRequest))
	}
